...
TEST(IMUManagerTest, GetStatsImuReject) {
  ...
  sh2_SensorEvent_t events[] = {
      {.timestamp_uS = 900000,
       ...
       .report = {0xFF, 0xF0, 0xF0, 0x00, 0x10, 0xF7, 0x00, 0x00, 0x20, 0xFE, 0x00, 0x00}},
      {.timestamp_uS = 1000000,
       .delay_uS = 0,
       .len = 12,
       .reportId = SH2_ACCELEROMETER,
       .report = {0x00, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00, 0x20, 0x4E, 0x00, 0x00}}
  };
...
TEST(IMUManagerTest, GetStatsImuAccept) {
  ...
  std::vector<sh2_SensorEvent_t> events = {
      {.timestamp_uS = 1010000,
       ...
       .report = {0x01, 0x00, 0x00, 0x00, 0x34, 0x12, 0x00, 0x00, 0x78, 0x56, 0x00, 0x00}},
      {.timestamp_uS = 1020000,
       .delay_uS = 10000,
       .len = 16,
       .reportId = SH2_ROTATION_VECTOR,
       .report = {0x02, 0x00, 0x00, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB, 0xCC}}
  };
...
TEST(IMUManagerTest, GetLatestGpsReturnsNullopt) { EXPECT_EQ(IMUManager::GetLatestGps(), std::nullopt); }
