...
// ----------------------------------------------------------------------------
// This test assumes that the y-axis of the IMU is perfectly aligned with the "forward" axis of the vehicle it is mounted on
...
TEST(IMUUtils, Calculating_Magnetic_Heading_From_Rotation_Vectors) {
  ...
  double rootOfTwo = std::sqrt(2.0)/2.0;

  const std::vector<Case> cases {

  {1, 0, 0, 0, 0.0},
  {rootOfTwo, 0, 0, rootOfTwo, 270.0},
  {0, 0, 0, 1, 180.0},
  {rootOfTwo, 0, 0, -rootOfTwo, 90.0},
  {0, 0, -1, 0, 0.0},
  {0, -rootOfTwo, -rootOfTwo, 0, 90.0},
  {0, -1, 0, 0, 180.0},
  {0, -rootOfTwo, rootOfTwo, 0, 270.0},
  {0, 0, -rootOfTwo, rootOfTwo, 180.0},
  {0.5, -0.5, -0.5, 0.5, 0.0},
  {rootOfTwo, -rootOfTwo, 0, 0, 180.0},
  {0.5, -0.5, 0.5, -0.5, 0.0},
  {-rootOfTwo, -rootOfTwo, 0, 0, 180.0},
  {-0.5, -0.5, -0.5, -0.5, 0.0},
  {0, 0, -rootOfTwo, -rootOfTwo, 180.0},
  {0.5, 0.5, -0.5, -0.5, 0.0},
  {-0.5, -0.5, -0.5, 0.5, 90.0},
  {0, -rootOfTwo, 0, rootOfTwo, 180.0},
  {0.5, -0.5, 0.5, 0.5, 270.0},
  {-rootOfTwo, 0, -rootOfTwo, 0, 0.0},
  {0.5, 0.5, -0.5, 0.5, 270.0},
  {0, -rootOfTwo, 0, -rootOfTwo, 180.0},
  {0.5, -0.5, -0.5, -0.5, 90.0},
  {rootOfTwo, 0, -rootOfTwo, 0, 0.0}
  ...
  for (const auto &c : cases) {
    double calculated = IMUUtils::Calculate_Magnetic_Heading(c.w_input, c.i_input, c.j_input, c.k_input);
    EXPECT_NEAR(calculated, c.magnetic_heading_output, 1e-3);
  };
};
// ----------------------------------------------------------------------------
